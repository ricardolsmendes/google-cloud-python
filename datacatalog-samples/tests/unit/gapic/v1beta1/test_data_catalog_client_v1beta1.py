...
class TestDataCatalogClient(object):
    ...
    def test_search_catalog(self):
        ...
        expected_request = datacatalog_pb2.SearchCatalogRequest(scope=scope, query=query)
    ...
    def test_update_entry(self):
        ...
        expected_response = {'name': name, 'linked_resource': linked_resource, 'display_name': display_name, 'description': description}
    ...
    def test_get_entry(self):
        ...
        display_name = 'displayName1615086568'
        description = 'description-1724546052'
        expected_response = {'name': name_2, 'linked_resource': linked_resource, 'display_name': display_name, 'description': description}
        expected_response = datacatalog_pb2.Entry(**expected_response)
    ...
    def test_create_tag_template(self):
        ...
        assert len(channel.requests) == 1
        expected_request = datacatalog_pb2.CreateTagTemplateRequest(parent=parent, tag_template_id=tag_template_id, tag_template=tag_template)
        actual_request = channel.requests[0][1]
        assert expected_request == actual_request
    ...
    def test_update_tag_template(self):
        ...
        assert len(channel.requests) == 1
        expected_request = datacatalog_pb2.UpdateTagTemplateRequest(tag_template=tag_template)
        actual_request = channel.requests[0][1]
        assert expected_request == actual_request
    ...
    def test_delete_tag_template(self):
        ...
        assert len(channel.requests) == 1
        expected_request = datacatalog_pb2.DeleteTagTemplateRequest(name=name, force=force)
        actual_request = channel.requests[0][1]
        assert expected_request == actual_request
    ...
    def test_create_tag_template_field(self):
        ...
        assert len(channel.requests) == 1
        expected_request = datacatalog_pb2.CreateTagTemplateFieldRequest(parent=parent, tag_template_field_id=tag_template_field_id, tag_template_field=tag_template_field)
        actual_request = channel.requests[0][1]
        assert expected_request == actual_request
    ...
    def test_create_tag_template_field_exception(self):
        ...
        with pytest.raises(CustomException):
            client.create_tag_template_field(parent, tag_template_field_id, tag_template_field)
    ...
    def test_update_tag_template_field(self):
        ...
        assert len(channel.requests) == 1
        expected_request = datacatalog_pb2.UpdateTagTemplateFieldRequest(name=name, tag_template_field=tag_template_field)
        actual_request = channel.requests[0][1]
        assert expected_request == actual_request
    ...
    def test_rename_tag_template_field(self):
        ...
        assert len(channel.requests) == 1
        expected_request = datacatalog_pb2.RenameTagTemplateFieldRequest(name=name, new_tag_template_field_id=new_tag_template_field_id)
        actual_request = channel.requests[0][1]
        assert expected_request == actual_request
    ...
    def test_delete_tag_template_field(self):
        ...
        assert len(channel.requests) == 1
        expected_request = datacatalog_pb2.DeleteTagTemplateFieldRequest(name=name, force=force)
        actual_request = channel.requests[0][1]
        assert expected_request == actual_request
    ...
    def test_create_tag(self):
        ...
        expected_response = {'name': name, 'template': template, 'template_display_name': template_display_name, 'column': column}
