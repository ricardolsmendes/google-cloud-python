...
from google.cloud.datacatalog_v1beta1.proto import schema_pb2 as google_dot_cloud_dot_datacatalog__v1beta1_dot_proto_dot_schema__pb2
from google.cloud.datacatalog_v1beta1.proto import search_pb2 as google_dot_cloud_dot_datacatalog__v1beta1_dot_proto_dot_search__pb2
from google.cloud.datacatalog_v1beta1.proto import table_spec_pb2 as google_dot_cloud_dot_datacatalog__v1beta1_dot_proto_dot_table__spec__pb2
from google.cloud.datacatalog_v1beta1.proto import tags_pb2 as google_dot_cloud_dot_datacatalog__v1beta1_dot_proto_dot_tags__pb2
from google.cloud.datacatalog_v1beta1.proto import timestamps_pb2 as google_dot_cloud_dot_datacatalog__v1beta1_dot_proto_dot_timestamps__pb2
...
_ENTRY = _descriptor.Descriptor(
  ...
  fields=[
    ...
    _descriptor.FieldDescriptor(
      ...
      serialized_options=None, file=DESCRIPTOR),
    _descriptor.FieldDescriptor(
      name='bigquery_table_spec', full_name='google.cloud.datacatalog.v1beta1.Entry.bigquery_table_spec', index=3,
      ...
      serialized_options=None, file=DESCRIPTOR),
    _descriptor.FieldDescriptor(
      name='bigquery_date_sharded_spec', full_name='google.cloud.datacatalog.v1beta1.Entry.bigquery_date_sharded_spec', index=4,
      ...
      serialized_options=None, file=DESCRIPTOR),
    _descriptor.FieldDescriptor(
      name='display_name', full_name='google.cloud.datacatalog.v1beta1.Entry.display_name', index=5,
      number=3, type=9, cpp_type=9, label=1,
      has_default_value=False, default_value=_b("").decode('utf-8'),
      message_type=None, enum_type=None, containing_type=None,
      is_extension=False, extension_scope=None,
      serialized_options=None, file=DESCRIPTOR),
    _descriptor.FieldDescriptor(
      name='description', full_name='google.cloud.datacatalog.v1beta1.Entry.description', index=6,
      ...
      serialized_options=None, file=DESCRIPTOR),
    _descriptor.FieldDescriptor(
      name='schema', full_name='google.cloud.datacatalog.v1beta1.Entry.schema', index=7,
      ...
      serialized_options=None, file=DESCRIPTOR),
    _descriptor.FieldDescriptor(
      name='source_system_timestamps', full_name='google.cloud.datacatalog.v1beta1.Entry.source_system_timestamps', index=8,
...
_SEARCHCATALOGRESPONSE.fields_by_name['results'].message_type = google_dot_cloud_dot_datacatalog__v1beta1_dot_proto_dot_search__pb2._SEARCHCATALOGRESULT
...
_ENTRY.fields_by_name['bigquery_table_spec'].message_type = google_dot_cloud_dot_datacatalog__v1beta1_dot_proto_dot_table__spec__pb2._BIGQUERYTABLESPEC
_ENTRY.fields_by_name['bigquery_date_sharded_spec'].message_type = google_dot_cloud_dot_datacatalog__v1beta1_dot_proto_dot_table__spec__pb2._BIGQUERYDATESHARDEDSPEC
_ENTRY.fields_by_name['schema'].message_type = google_dot_cloud_dot_datacatalog__v1beta1_dot_proto_dot_schema__pb2._SCHEMA
_ENTRY.fields_by_name['source_system_timestamps'].message_type = google_dot_cloud_dot_datacatalog__v1beta1_dot_proto_dot_timestamps__pb2._SYSTEMTIMESTAMPS
...
_CREATETAGTEMPLATEREQUEST.fields_by_name['tag_template'].message_type = google_dot_cloud_dot_datacatalog__v1beta1_dot_proto_dot_tags__pb2._TAGTEMPLATE
_UPDATETAGTEMPLATEREQUEST.fields_by_name['tag_template'].message_type = google_dot_cloud_dot_datacatalog__v1beta1_dot_proto_dot_tags__pb2._TAGTEMPLATE
_UPDATETAGTEMPLATEREQUEST.fields_by_name['update_mask'].message_type = google_dot_protobuf_dot_field__mask__pb2._FIELDMASK
_CREATETAGREQUEST.fields_by_name['tag'].message_type = google_dot_cloud_dot_datacatalog__v1beta1_dot_proto_dot_tags__pb2._TAG
_UPDATETAGREQUEST.fields_by_name['tag'].message_type = google_dot_cloud_dot_datacatalog__v1beta1_dot_proto_dot_tags__pb2._TAG
_UPDATETAGREQUEST.fields_by_name['update_mask'].message_type = google_dot_protobuf_dot_field__mask__pb2._FIELDMASK
_CREATETAGTEMPLATEFIELDREQUEST.fields_by_name['tag_template_field'].message_type = google_dot_cloud_dot_datacatalog__v1beta1_dot_proto_dot_tags__pb2._TAGTEMPLATEFIELD
_UPDATETAGTEMPLATEFIELDREQUEST.fields_by_name['tag_template_field'].message_type = google_dot_cloud_dot_datacatalog__v1beta1_dot_proto_dot_tags__pb2._TAGTEMPLATEFIELD
...
_LISTTAGSRESPONSE.fields_by_name['tags'].message_type = google_dot_cloud_dot_datacatalog__v1beta1_dot_proto_dot_tags__pb2._TAG
...
SearchCatalogRequest = _reflection.GeneratedProtocolMessageType('SearchCatalogRequest', (_message.Message,), dict(
...
SearchCatalogResponse = _reflection.GeneratedProtocolMessageType('SearchCatalogResponse', (_message.Message,), dict(
...
UpdateEntryRequest = _reflection.GeneratedProtocolMessageType('UpdateEntryRequest', (_message.Message,), dict(
...
LookupEntryRequest = _reflection.GeneratedProtocolMessageType('LookupEntryRequest', (_message.Message,), dict(
...
CreateTagTemplateRequest = _reflection.GeneratedProtocolMessageType('CreateTagTemplateRequest', (_message.Message,), dict(
...
GetTagTemplateRequest = _reflection.GeneratedProtocolMessageType('GetTagTemplateRequest', (_message.Message,), dict(
...
UpdateTagTemplateRequest = _reflection.GeneratedProtocolMessageType('UpdateTagTemplateRequest', (_message.Message,), dict(
...
DeleteTagTemplateRequest = _reflection.GeneratedProtocolMessageType('DeleteTagTemplateRequest', (_message.Message,), dict(
...
CreateTagTemplateFieldRequest = _reflection.GeneratedProtocolMessageType('CreateTagTemplateFieldRequest', (_message.Message,), dict(
...
UpdateTagTemplateFieldRequest = _reflection.GeneratedProtocolMessageType('UpdateTagTemplateFieldRequest', (_message.Message,), dict(
...
RenameTagTemplateFieldRequest = _reflection.GeneratedProtocolMessageType('RenameTagTemplateFieldRequest', (_message.Message,), dict(
...
DeleteTagTemplateFieldRequest = _reflection.GeneratedProtocolMessageType('DeleteTagTemplateFieldRequest', (_message.Message,), dict(
...
_DATACATALOG = _descriptor.ServiceDescriptor(
  ...
  file=DESCRIPTOR,
  index=0,
  serialized_options=_b('\312A\032datacatalog.googleapis.com\322A.https://www.googleapis.com/auth/cloud-platform'),
  ...
  _descriptor.MethodDescriptor(
    ...
    serialized_options=_b('\202\323\344\223\002\034\"\027/v1beta1/catalog:search:\001*'),
  ),
  _descriptor.MethodDescriptor(
    name='UpdateEntry',
    ...
    output_type=_ENTRY,
    serialized_options=_b('\202\323\344\223\002M2D/v1beta1/{entry.name=projects/*/locations/*/entryGroups/*/entries/*}:\005entry'),
  ),
  _descriptor.MethodDescriptor(
    name='GetEntry',
    ...
    output_type=_ENTRY,
    serialized_options=_b('\202\323\344\223\002@\022>/v1beta1/{name=projects/*/locations/*/entryGroups/*/entries/*}'),
  ),
  _descriptor.MethodDescriptor(
    name='LookupEntry',
    ...
    output_type=_ENTRY,
    serialized_options=_b('\202\323\344\223\002\031\022\027/v1beta1/entries:lookup'),
  ),
  _descriptor.MethodDescriptor(
    ...
    serialized_options=_b('\202\323\344\223\002E\"5/v1beta1/{parent=projects/*/locations/*}/tagTemplates:\014tag_template'),
  ),
  _descriptor.MethodDescriptor(
    name='GetTagTemplate',
    ...
    output_type=google_dot_cloud_dot_datacatalog__v1beta1_dot_proto_dot_tags__pb2._TAGTEMPLATE,
    serialized_options=_b('\202\323\344\223\0027\0225/v1beta1/{name=projects/*/locations/*/tagTemplates/*}'),
  ),
  _descriptor.MethodDescriptor(
    ...
    output_type=google_dot_cloud_dot_datacatalog__v1beta1_dot_proto_dot_tags__pb2._TAGTEMPLATE,
    serialized_options=_b('\202\323\344\223\002R2B/v1beta1/{tag_template.name=projects/*/locations/*/tagTemplates/*}:\014tag_template'),
  ),
  _descriptor.MethodDescriptor(
    ...
    serialized_options=_b('\202\323\344\223\0027*5/v1beta1/{name=projects/*/locations/*/tagTemplates/*}'),
  ),
  _descriptor.MethodDescriptor(
    ...
    serialized_options=_b('\202\323\344\223\002T\">/v1beta1/{parent=projects/*/locations/*/tagTemplates/*}/fields:\022tag_template_field'),
  ),
  _descriptor.MethodDescriptor(
    ...
    output_type=google_dot_cloud_dot_datacatalog__v1beta1_dot_proto_dot_tags__pb2._TAGTEMPLATEFIELD,
    serialized_options=_b('\202\323\344\223\002T2>/v1beta1/{name=projects/*/locations/*/tagTemplates/*/fields/*}:\022tag_template_field'),
  ),
  _descriptor.MethodDescriptor(
    ...
    output_type=google_dot_cloud_dot_datacatalog__v1beta1_dot_proto_dot_tags__pb2._TAGTEMPLATEFIELD,
    serialized_options=_b('\202\323\344\223\002J\"E/v1beta1/{name=projects/*/locations/*/tagTemplates/*/fields/*}:rename:\001*'),
  ),
  _descriptor.MethodDescriptor(
    ...
    output_type=google_dot_protobuf_dot_empty__pb2._EMPTY,
    serialized_options=_b('\202\323\344\223\002@*>/v1beta1/{name=projects/*/locations/*/tagTemplates/*/fields/*}'),
  ),
  _descriptor.MethodDescriptor(
    name='CreateTag',
    ...
    serialized_options=_b('\202\323\344\223\002L\"E/v1beta1/{parent=projects/*/locations/*/entryGroups/*/entries/*}/tags:\003tag'),
  ),
  _descriptor.MethodDescriptor(
    name='UpdateTag',
    ...
    output_type=google_dot_cloud_dot_datacatalog__v1beta1_dot_proto_dot_tags__pb2._TAG,
    serialized_options=_b('\202\323\344\223\002P2I/v1beta1/{tag.name=projects/*/locations/*/entryGroups/*/entries/*/tags/*}:\003tag'),
  ),
  _descriptor.MethodDescriptor(
    name='DeleteTag',
    ...
    output_type=google_dot_protobuf_dot_empty__pb2._EMPTY,
    serialized_options=_b('\202\323\344\223\002G*E/v1beta1/{name=projects/*/locations/*/entryGroups/*/entries/*/tags/*}'),
  ),
  _descriptor.MethodDescriptor(
    name='ListTags',
    ...
    serialized_options=_b('\202\323\344\223\002G\022E/v1beta1/{parent=projects/*/locations/*/entryGroups/*/entries/*}/tags'),
  ),
  _descriptor.MethodDescriptor(
    name='SetIamPolicy',
    ...
    serialized_options=_b('\202\323\344\223\002K\"F/v1beta1/{resource=projects/*/locations/*/tagTemplates/*}:setIamPolicy:\001*'),
  ),
  _descriptor.MethodDescriptor(
    name='GetIamPolicy',
    ...
    output_type=google_dot_iam_dot_v1_dot_policy__pb2._POLICY,
    serialized_options=_b('\202\323\344\223\002K\"F/v1beta1/{resource=projects/*/locations/*/tagTemplates/*}:getIamPolicy:\001*'),
  ),
  _descriptor.MethodDescriptor(
    ...
    serialized_options=_b('\202\323\344\223\002Q\"L/v1beta1/{resource=projects/*/locations/*/tagTemplates/*}:testIamPermissions:\001*'),
  ),
])
