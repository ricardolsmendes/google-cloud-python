...
_TAGTEMPLATEFIELD = _descriptor.Descriptor(
  ...
  fields=[
    _descriptor.FieldDescriptor(
      name='display_name', full_name='google.cloud.datacatalog.v1beta1.TagTemplateField.display_name', index=0,
      number=1, type=9, cpp_type=9, label=1,
      has_default_value=False, default_value=_b("").decode('utf-8'),
      message_type=None, enum_type=None, containing_type=None,
      is_extension=False, extension_scope=None,
      serialized_options=None, file=DESCRIPTOR),
    _descriptor.FieldDescriptor(
      name='type', full_name='google.cloud.datacatalog.v1beta1.TagTemplateField.type', index=1,
      number=2, type=11, cpp_type=10, label=1,
      has_default_value=False, default_value=None,
      message_type=None, enum_type=None, containing_type=None,
      is_extension=False, extension_scope=None,
...
TagField = _reflection.GeneratedProtocolMessageType('TagField', (_message.Message,), dict(
...
TagTemplate = _reflection.GeneratedProtocolMessageType('TagTemplate', (_message.Message,), dict(
...
TagTemplateField = _reflection.GeneratedProtocolMessageType('TagTemplateField', (_message.Message,), dict(
